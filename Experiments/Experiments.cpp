...
string STEGO_NAMES = "stegoNames";
string SECRET_NAMES = "secretNames";
string STEGO_DIR = "/home/xnpio/Descargas/stegoImg/Seam_carved/";
string SECRET_DIR = "/home/xnpio/Descargas/secretImg/";
string HISTOGRAM_DIR = "Histograms/";
...
int main(int argc, char ** argv){
	srand(time(NULL));
	if(argc != 2){
		cout<<"Faltan argumentos <iteracioens>"<<endl;
		return 0;
	}	
...
/*
	stegoImg1 = CImg<int>("1505.jpg");
	stegoImg2 = CImg<int>("4336.jpg");
	h11 = stegoImg1.get_histogram(256);
	h21 = stegoImg2.get_histogram(256);
	outstegoImg1 = CImg<int>("out1505.bmp");
	outstegoImg2 = CImg<int>("out4336.bmp");
